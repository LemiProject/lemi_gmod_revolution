...
IMGUI_IMPL_API LRESULT ImGui_ImplWin32_WndProcHandler(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    ...
    //    return 0;
    //case WM_SETCURSOR:
    //    if (LOWORD(lParam) == HTCLIENT && ImGui_ImplWin32_UpdateMouseCursor()) TODO:  if (LOWORD(lParam) == HTCLIENT && ImGui_ImplWin32_UpdateMouseCursor()) courses cursor bug! 
    //        return 1;
    //    return 0;
    ...
    case WM_CHAR:
        ...
        {
            wchar_t w_char;
            MultiByteToWideChar(CP_ACP, MB_PRECOMPOSED, (char*)&wParam, 1, &w_char, 1);
            io.AddInputCharacter(w_char);
